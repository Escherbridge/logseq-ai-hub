...
describe("registerAllMcpHandlers", () => {
  test("registers all tools, resources, and prompts together", () => {
    ...
    // Tools: graph, job, memory, messaging, character (13), event (6), character-session (3), approval, registry, session, project, adr, lesson, safeguard, work, task, pidev
    expect(toolCount).toBe(89);
